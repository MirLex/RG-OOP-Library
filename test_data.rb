def createTestData
	...
	orders = []
	orders << order01 = Order.new(programmingRuby, deborahBlack)
	orders << order02 = Order.new(rubyBestPractices, deborahBlack) 
	orders << order03 = Order.new(nineteenEightyFou, haroldRay) 
	...
	orders << order13 = Order.new(rubyBestPractices, marvinDuran) 
	orders << order14 = Order.new(rubyBestPractices, marvinDuran) 
